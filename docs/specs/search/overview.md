...
```json
{
  ...
  "actions": [
    {
      "command": "/goto contracts/henderson-msa",
      "label": "Go to Henderson MSA"
    }
  ]
}
```
...
```json
{
  ...
  "communications": [
    {
      "id": "...",
      "snippet": "Thomas mentioned renewal terms...",
      "sender": "tburke@acme.com",
  ...
  "actions": [
    {
      "command": "/goto crm/thomas-burke",
      "label": "Go to Thomas Burke",
      "badge": "Action"
    }
  ]
}
