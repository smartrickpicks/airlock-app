...
1. Restate the user's request as a single sentence: *"So you want X, which means Y in the codebase."*
...
*Only after user confirms Gate 1.*
...
*Only after user says "go" or equivalent.*
...
*Only after user says "ship" or equivalent.*
