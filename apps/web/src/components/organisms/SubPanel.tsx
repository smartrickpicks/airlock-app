...
const ADMIN_TIERS = [
  {
    label: "Foundation",
    nodes: [
      { id: "workspace", label: "Workspace", icon: Building2, route: "/admin/workspace" },
      { id: "ai_provider", label: "AI Provider", icon: Brain, route: "/admin/ai-provider" },
      { id: "data_source", label: "Data Source", icon: Database, route: "/admin/data-source" },
    ],
  },
  {
    label: "Platform",
    nodes: [
      { id: "modules", label: "Modules", icon: LayoutGrid, route: "/admin/modules" },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: "mcp_servers", label: "MCP Servers", icon: Server, route: "/admin/mcp-servers" },
      { id: "skills", label: "Skills", icon: Wand2, route: "/admin/skills" },
      { id: "integrations", label: "Integrations", icon: Plug, route: "/admin/integrations" },
    ],
  },
  {
    label: "Scale",
    nodes: [
      { id: "workflows", label: "Workflows", icon: GitBranch, route: "/admin/workflows" },
      { id: "event_bus", label: "Event Bus", icon: Radio, route: "/admin/event-bus" },
      { id: "feature_flags", label: "Feature Flags", icon: Flag, route: "/admin/features" },
    ],
  },
];
...
export default function SubPanel() {
  ...
  const currentModule = !isAdmin ? MODULES[activeModule as keyof typeof MODULES] : null;
