...
export default function AdminModulesPage() {
  const config = useCapabilityTreeStore((s) => s.nodeConfigs["modules"] ?? {});
  const state = useCapabilityTreeStore((s) => s.nodeStates["modules"] ?? "available");
    ...
    <div className="h-full overflow-y-auto p-6">
      <div className="max-w-2xl">
        ...
        <p className="mt-1 text-sm text-text-secondary">
          Enable or disable modules and configure per-module settings.
        </p>
