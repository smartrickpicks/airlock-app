...
export default function AdminIntegrationsPage() {
  const config = useCapabilityTreeStore((s) => s.nodeConfigs["integrations"] ?? {});
  const state = useCapabilityTreeStore((s) => s.nodeStates["integrations"] ?? "available");
    ...
    <div className="h-full overflow-y-auto p-6">
      <div className="max-w-2xl">
        ...
        <p className="mt-1 text-sm text-text-secondary">
          Connect OAuth and API key integrations: Google Drive, Salesforce, Slack, Jira.
        </p>
