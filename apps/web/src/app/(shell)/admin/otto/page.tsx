...
export default function AdminOttoPage() {
  const config = useCapabilityTreeStore((s) => s.nodeConfigs["otto"] ?? {});
  const state = useCapabilityTreeStore((s) => s.nodeStates["otto"] ?? "available");
    ...
    <div className="h-full overflow-y-auto p-6">
      <div className="max-w-2xl">
        ...
        <p className="mt-1 text-sm text-text-secondary">
          Configure OTTO AI assistant behavior, context, and tool permissions.
        </p>
