      ...
      <div className="max-w-2xl space-y-6">
        ...
        <div className="rounded-lg border border-surface-border bg-surface-raised p-4">
          ...
          <p className="text-xs text-text-secondary">
            Requests route to{" "}
            <strong className="text-text-primary">Claude Sonnet 4.6</strong> by
            default. On 5xx errors or rate limits, traffic falls to GPT-4o, then
            to Ollama (local) if configured. The gateway is managed by LiteLLM
            running on the API server.
          </p>
        </div>
      </div>
    </div>
